...
sealed class AndroidDependency(val group: String, val name: String, var version: String) {
    ...
    sealed class Group(
        ...
        sealed class Test(
            ...
            object Junit : Test("junit", "junit", "4.13")
        ...
        sealed class XPopup(
            name: String
        ) : AndroidDependency("com.lxj", name, "2.2.0") {
         ...
         */
        sealed class Download(name: String) : Group("com.arialyy.aria", name, "3.8.15") {
